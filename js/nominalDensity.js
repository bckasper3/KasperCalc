...
function updateCalculator() {
  ...
  if (flag == true) {
      ...
      document.getElementById("result_density4").innerText = ((interpolatedValue*0.001).toFixed(5));
      document.getElementById("result_density5").innerText = ((interpolatedValue/interp_densityWater).toFixed(5));
      document.getElementById("result_density6").innerText = (((141.5/(interpolatedValue/interp_densityWater))-131.5).toFixed(5));
  }
}
