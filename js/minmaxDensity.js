...
function updateCalculator() {
  ...
  if (flag == true) {
      ...
      document.getElementById("result_density2").innerText = ((interpolatedValue*1000).toFixed(3));
      document.getElementById("result_density3").innerText = ((interpolatedValue*0.000036127298147753*1000).toFixed(4));
      document.getElementById("result_density4").innerText = ((interpolatedValue*0.0083454063545262*1000).toFixed(4));
