...
const csvFiles = [
  '../csvData/propylenegylcol/pg-8.csv', // Replace with actual file paths or URLs
  '../csvData/propylenegylcol/pg-9.csv',
  '../csvData/propylenegylcol/pg-10.csv',
  '../csvData/propylenegylcol/pg-11.csv',
  '../csvData/propylenegylcol/pg-12.csv',
  '../csvData/propylenegylcol/pg-13.csv',
  '../csvData/propylenegylcol/pg-14.csv',
];
        ...
        options: {
          ...
          scales: {
            ...
            y:{
              ...
              title: {
                display:true,
                text: 'Specific Heat Capacity, Cp (KJ/(Kg*K))',
                padding: 10,
                font: {
                  size: 20,
                },
...
function calculate() {
  ...
  if (flag == true) {
      ...
      document.getElementById("result_density2").innerText = ((interpolatedValue).toFixed(4));
      document.getElementById("result_density3").innerText = ((interpolatedValue).toFixed(4));
      document.getElementById("result_density4").innerText = ((interpolatedValue*1000).toFixed(1));
      document.getElementById("result_density5").innerText = ((interpolatedValue*0.239).toFixed(5));
      document.getElementById("result_density6").innerText = ((interpolatedValue*0.239).toFixed(5));
      document.getElementById("result_density7").innerText = ((interpolatedValue*0.239).toFixed(5));
      document.getElementById("result_density8").innerText = ((interpolatedValue*0.000278).toFixed(7));
  }
}
