    ...
    _update(r=Date.now()) {
        ...
        this._charts.forEach((a,s)=>{
            if (a.running && a.items.length) {
                const n = a.items;
                let t = n.length - 1, e = !1, i;
                for (; 0 <= t; --t)
                    (i = n[t])._active ? (i._total > a.duration && (a.duration = i._total),
                    i.tick(r),
                    e = !0) : (n[t] = n[n.length - 1],
                    n.pop());
                e && (s.draw(),
                this._notify(s, a, r, "progress")),
                n.length || (a.running = !1,
...
class Animation {
    ...
    tick(t) {
        var t = t - this._start
          ...
          , n = this._to;
        let r;
        if (this._active = a !== n && (s || t < e),
        !this._active)
            return this._target[i] = n,
            void this._notify(!0);
        t < 0 ? this._target[i] = a : (r = t / e % 2,
        r = s && 1 < r ? 2 - r : r,
        ...
        for (o = t.length - 1; 0 <= o; --o) {
            ...
            if ("$" !== d.charAt(0))
                if ("options" === d)
                    ...
                    h && h.duration ? (n[d] = t = new Animation(h,e,d,l),
                    s.push(t)) : e[d] = l
                }
        }
        return s
    ...
    update(t, e) {
        {
            if (0 !== this._properties.size)
                return (t = this._createAnimations(t, e)).length ? (animator.add(this._chart, t),
                !0) : void 0;
            Object.assign(t, e)
        }
    }
...
function updateStacks(t, e) {
    ...
    for (let t = 0; t < d; ++t) {
        ...
        const f = p._stacks || (p._stacks = {})
          , m = ((c = f[l] = getOrCreateStack(s, h, u))[r] = g,
...
function clearStacks(t, e) {
    ...
    if (a)
        for (const s of e = e || t._parsed) {
            const n = s._stacks;
            if (!n || void 0 === n[a] || void 0 === n[a][i])
                return;
            delete n[a][i],
            void 0 !== n[a]._visualValues && void 0 !== n[a]._visualValues[i] && delete n[a]._visualValues[i]
        }
}
...
class DatasetController {
    ...
    updateIndex(t) {
        this.index !== t && clearStacks(this._cachedMeta),
        this.index = t
    }
    linkScales() {
        var t = this.chart;
    ...
    _dataCheck() {
        ...
        var e = t.data || (t.data = [])
          , i = this._data;
        if (isObject(e))
            this._data = convertObjectDataToArray(e);
        else if (i !== e) {
            if (i) {
    ...
    parse(t, e) {
        ...
        const r = s.axis;
        let o = 0 === t && e === a.length || i._sorted, l = 0 < t && i._parsed[t - 1], h, d, c;
        if (!1 === this._parsing)
            i._parsed = a,
            i._sorted = !0,
            c = a;
    ...
    updateRangeFromParsed(t, e, i, a) {
        ...
        a && i && (a.values = i,
        n = applyStack(a, s, this._cachedMeta.index)),
    ...
    getMinMax(e, t) {
        ...
        for (c = 0; c < n && (g() || (this.updateRangeFromParsed(l, e, u, o),
        !s)); ++c)
            ;
        if (s)
            for (c = n - 1; 0 <= c; --c)
    ...
    _update(t) {
        ...
        e._clip = toClip(valueOrDefault(this.options.clip, defaultClip(e.xScale, e.yScale, this.getMaxOverflow())))
    }
    update(t) {}
    draw() {
        var t = this._ctx
        ...
        let h;
        for (i.dataset && i.dataset.draw(t, s, r, o),
        h = r; h < r + o; ++h) {
            const d = a[h];
    ...
    getContext(t, e, i) {
        ...
        if (0 <= t && t < this._cachedMeta.data.length) {
            ...
            (s = n.$context || (n.$context = createDataContext(this.getContext(), t, n))).parsed = this.getParsed(t),
            s.raw = a.data[t],
            s.index = s.dataIndex = t
        } else
            (s = this.$context || (this.$context = createDatasetContext(this.chart.getContext(), this.index))).dataset = a,
    ...
    _resolveElementOptions(t, e="default", i) {
        ...
        return d.$shared && (d.$shared = o,
        s[n] = Object.freeze(cloneIfNotShared(d, o))),
        d
    }
    _resolveAnimations(t, e, i) {
        ...
        return o && o._cacheable && (s[n] = Object.freeze(r)),
        r
    }
    getSharedOptions(t) {
        if (t.$shared)
    ...
    _resyncElements(t) {
        var e, i, a, s = this._data, n = this._cachedMeta.data;
        for ([e,i,a] of this._syncList)
            this[e](i, a);
        this._syncList = [];
        var n = n.length
          , s = s.length
          , r = Math.min(s, n);
        r && this.parse(0, r),
        n < s ? this._insertElements(n, s - n, t) : s < n && this._removeElements(s, n - s)
    }
    ...
    _removeElements(t, e) {
        const i = this._cachedMeta;
        var a;
        this._parsing && (a = i._parsed.splice(t, e),
        i._stacked && clearStacks(i, a)),
        i.data.splice(t, e)
    }
    _sync(t) {
        var e, i, a;
        this._parsing ? this._syncList.push(t) : ([e,i,a] = t,
        this[e](i, a)),
...
function computeMinSampleSize(t) {
    ...
    let a = e._length, s, n, r, o;
    var l = ()=>{
        32767 !== r && -32768 !== r && (defined(o) && (a = Math.min(a, Math.abs(r - o) || a)),
        o = r)
    }
    ;
    for (s = 0,
    n = i.length; s < n; ++s)
        r = e.getPixelForValue(i[s]),
        l();
    for (o = void 0,
    s = 0,
    n = e.ticks.length; s < n; ++s)
        r = e.getPixelForTick(s),
        l();
    return a
}
function computeFitCategoryTraits(t, e, i, a) {
    ...
    let n, r;
    return r = isNullOrUndef(s) ? (n = e.min * i.categoryPercentage,
    i.barPercentage) : (n = s * a,
    1),
    {
        chunk: n / a,
        ratio: r,
...
function parseValue(t, e, i, a) {
    return isArray(t) ? parseFloatBar(t, e, i, a) : e[i.axis] = i.parse(t, a),
    e
}
...
function borderProps(t) {
    let e, i, a, s, n;
    return a = t.horizontal ? (e = t.base > t.x,
    i = "left",
    "right") : (e = t.base < t.y,
    i = "bottom",
    "top"),
...
function setBorderSkipped(t, e, i, a) {
    ...
    s = (i._top || 0) === a ? l : (i._bottom || 0) === a ? h : (n[parseEdge(h, e, r, o)] = !0,
    l)),
    n[parseEdge(s, e, r, o)] = !0,
    t.borderSkipped = n) : t.borderSkipped = n
}
...
class BarController extends DatasetController {
    ...
    updateElements(e, i, a, s) {
        var n = "reset" === s;
        const {index: r, _cachedMeta: {vScale: o}} = this;
        ...
        for (const r of a)
            if ((void 0 === i || !(t=>{
                var e = t.controller.getParsed(i)
                  , e = e && e[t.vScale.axis];
                if (isNullOrUndef(e) || isNaN(e))
                    return !0
            }
            )(r)) && ((!1 === s || -1 === n.indexOf(r.stack) || void 0 === s && void 0 === r.stack) && n.push(r.stack),
            r.index === t))
                break;
    ...
    _calculateBarValuePixels(t) {
        const {_cachedMeta: {vScale: e, _stacked: i, index: a}, options: {base: s, minBarLength: n}} = this;
        var r = s || 0;
        const o = this.getParsed(t);
        var l = o._custom
          , h = isFloatBar(l);
        let d = o[e.axis], c = 0, u = i ? this.applyStack(e, o, i) : d, g, p;
        u !== d && (c = u - d,
        u = d),
        h && (d = l.barStart,
        ...
        c += d);
        var f, l = isNullOrUndef(s) || h ? c : s;
        let m = e.getPixelForValue(l);
        return g = this.chart.getDataVisibility(t) ? e.getPixelForValue(c + u) : m,
        p = g - m,
        Math.abs(p) < n && (p = barSign(p, e, r) * n,
        d === r && (m -= p / 2),
        ...
        m === e.getPixelForValue(r) && (t = sign(p) * e.getLineWidthForValue(r) / 2,
        m += t,
        p -= t),
        {
            size: p,
    ...
    _calculateBarIndexPixels(t, e) {
        const i = e.scale;
        var a, s = this.options, n = s.skipNull, r = valueOrDefault(s.maxBarThickness, 1 / 0);
        let o, l;
        return l = e.grouped ? (a = n ? this._getStackCount(t) : e.stackCount,
        ...
        Math.min(r, s.chunk * s.ratio)) : (o = i.getPixelForValue(this.getParsed(t)[i.axis], t),
...
class BubbleController extends DatasetController {
    ...
    updateElements(e, i, a, s) {
        ...
        for (let t = i; t < i + a; t++) {
            ...
            h && (f.options = l || this.resolveDataElementOptions(t, u.active ? "active" : s),
...
class DoughnutController extends DatasetController {
    ...
    updateElements(t, e, i, a) {
        ...
        for (p = e; p < e + i; ++p) {
            ...
            u && (v.options = c || this.resolveDataElementOptions(p, m.active ? "active" : a)),
            g += f,
    ...
    getMaxBorderWidth(t) {
        ...
        if (!t)
            for (a = 0,
            s = i.data.datasets.length; a < s; ++a)
                if (i.isDatasetVisible(a)) {
                    t = (n = i.getDatasetMeta(a)).data,
                    r = n.controller;
                    break
                }
        if (!t)
...
class LineController extends DatasetController {
    ...
    updateElements(e, i, t, a) {
        ...
        for (let t = 0; t < x; ++t) {
            var _, y, k, S, D = e[t];
            const M = m ? D : {};
            t < i || t >= v ? M.skip = !0 : (_ = this.getParsed(t),
            y = isNullOrUndef(_[u]),
...
class PolarAreaController extends DatasetController {
    ...
    getMinMax() {
        ...
        return t.data.forEach((t,e)=>{
            ...
            !isNaN(i) && this.chart.getDataVisibility(e) && (i < a.min && (a.min = i),
            i > a.max && (a.max = i))
        }
        ),
        a
    ...
    updateElements(a, t, e, s) {
        ...
        for (g = t; g < t + e; g++) {
            ...
            u = e,
            n && (o.animateScale && (i = 0),
            o.animateRotate && (t = e = c));
            var m = {
                x: h,
                y: d,
                innerRadius: 0,
...
class ScatterController extends DatasetController {
    ...
    update(t) {
        ...
        this._drawCount = n,
        _scaleRangesChanged(e) && (s = 0,
        n = i.length),
        this.options.showLine) {
            this.datasetElementType || this.addElements();
            const {dataset: r, _dataset: o} = e
              , l = (r._chart = this.chart,
    ...
    getMaxOverflow() {
        ...
        t = t.dataset,
        t = t.options && t.options.borderWidth || 0;
        if (!i.length)
            return t;
...
function getNearestCartesianItems(n, r, t, o, l, h) {
    ...
    return evaluateInteractionItems(n, t, r, function(t, e, i) {
        ...
        o && !s || (a = t.getCenterPoint(l),
        (h || n.isPointInArea(a) || s) && ((s = c(r, a)) < u ? (d = [{
            element: t,
            datasetIndex: e,
            index: i
        }],
...
function wrapBoxes(t) {
    ...
    for (i = 0,
    a = (t || []).length; i < a; ++i)
        ({position: n, options: {stack: r, stackWeight: o=1}} = s = t[i]),
        e.push({
            index: i,
            box: s,
            pos: n,
...
function setLayoutDims(t, e) {
    ...
    r = t.length; n < r; ++n) {
        ...
        o.horizontal ? (o.width = h ? h * a : l && e.availableWidth,
        o.height = s) : (o.width = a,
        o.height = h ? h * s : l && e.availableHeight)
    }
    return i
}
...
function fitBoxes(t, e, i, a) {
    ...
    h = 0; n < r; ++n) {
        o = t[n],
        (l = o.box).update(o.width || e.w, o.height || e.h, getMargins(o.horizontal, e));
...
function placeBoxes(t, e, i, a) {
    ...
    for (const c of t) {
        ...
        var l, h, d = c.stackWeight / u.weight || 1;
        c.horizontal ? (h = e.w * d,
        l = u.size || o.height,
...
function createAttachObserver(t, e, a) {
    const s = t.canvas
      , i = new MutationObserver(t=>{
        let e = !1;
        for (const i of t)
            e = (e = e || nodeListContains(i.addedNodes, s)) && !nodeListContains(i.removedNodes, s);
        e && a()
    }
    );
...
function createDetachObserver(t, e, a) {
    const s = t.canvas
      , i = new MutationObserver(t=>{
        let e = !1;
        for (const i of t)
            e = (e = e || nodeListContains(i.removedNodes, s)) && !nodeListContains(i.addedNodes, s);
        e && a()
    }
    );
    return i.observe(document, {
...
function onWindowResize() {
    ...
    i !== oldDevicePixelRatio && (oldDevicePixelRatio = i,
...
function unlistenDevicePixelRatioChanges(t) {
    ...
    drpListeningCharts.size || window.removeEventListener("resize", onWindowResize)
}
function createResizeObserver(t, e, a) {
    ...
    if (s) {
        ...
        return r.observe(s),
        listenDevicePixelRatioChanges(t, n),
        r
    }
}
...
function createProxyAndListen(e, t, i) {
    ...
    , e);
    return addListener(a, t, s),
    s
}
class DomPlatform extends BasePlatform {
    acquireContext(t, e) {
        var i = t && t.getContext && t.getContext("2d");
        return i && i.canvas === t ? (initCanvas(t, e),
        i) : null
    }
    releaseContext(t) {
        const i = t.canvas;
...
function autoSkip(i, a) {
    var s = i.options.ticks
      ...
      , l = [];
    if (i < s)
        return skipMajors(a, l, n, s / i),
        l;
    var h = calculateSpacing(n, a, i);
    if (0 < s) {
        let t, e;
        i = 1 < s ? Math.round((o - r) / (s - 1)) : null;
        for (skip(a, l, h, isNullOrUndef(i) ? 0 : r - i, r),
        t = 0,
        e = s - 1; t < e; t++)
            skip(a, l, h, n[t], n[t + 1]);
        return skip(a, l, h, o, isNullOrUndef(i) ? a.length : o + i),
        l
    }
    return skip(a, l, h),
    l
...
function getPixelForGridLine(t, e, i) {
    var a = t.ticks.length
      ...
      , n = t._startPixel
      , r = t._endPixel;
    let o = t.getPixelForTick(s), l;
    if (!(i && (l = 1 === a ? Math.max(o - n, r - o) : 0 === e ? (t.getPixelForTick(1) - o) / 2 : (o - t.getPixelForTick(s - 1)) / 2,
...
function titleArgs(t, e, i, a) {
    ...
    let c = 0, u, g, p;
    var f, m, l = r - s, v = o - n;
    return t.isHorizontal() ? (g = _alignStartEnd(a, n, o),
    p = isObject(i) ? (m = i[f = Object.keys(i)[0]],
    d[f].getPixelForValue(m) + l - e) : "center" === i ? (h.bottom + h.top) / 2 + l - e : offsetFromEdge(t, i, e),
    u = o - n) : (g = isObject(i) ? (m = i[f = Object.keys(i)[0]],
    d[f].getPixelForValue(m) - v + e) : "center" === i ? (h.left + h.right) / 2 - v + e : offsetFromEdge(t, i, e),
...
class Scale extends Element {
    ...
    update(t, e, i) {
        ...
        n.display && (n.autoSkip || "auto" === n.source) && (this.ticks = autoSkip(this, this.ticks),
        this._labelSizes = null,
        this.afterAutoSkip()),
    ...
    calculateLabelRotation() {
        var t, e, i, a, s = this.options, n = s.ticks, r = getTicksLimit(this.ticks.length, s.ticks.maxTicksLimit), o = n.minRotation || 0, l = n.maxRotation;
        let h = o;
        !this._isVisible() || !n.display || l <= o || r <= 1 || !this.isHorizontal() ? this.labelRotation = o : (e = (t = this._getLabelSizes()).widest.width,
        i = t.highest.height,
        a = _limitValue(this.chart.width - e, 0, this.maxWidth),
        (s.offset ? this.maxWidth / r : a / (r - 1)) < e + 6 && (a = a / (r - (s.offset ? .5 : 1)),
    ...
    fit() {
        ...
        var e, i, a, s, n, {chart: r, options: {ticks: o, title: l, grid: h}} = this, d = this._isVisible(), c = this.isHorizontal();
        d && (d = getTitleHeight(l, r.options.font),
        c ? (t.width = this.maxWidth,
        t.height = getTickMarkLength(h) + d) : (t.height = this.maxHeight,
        t.width = getTickMarkLength(h) + d),
        o.display && this.ticks.length && ({first: l, last: h, widest: d, highest: e} = this._getLabelSizes(),
        i = 2 * o.padding,
        s = toRadians(this.labelRotation),
        a = Math.cos(s),
        s = Math.sin(s),
        c ? (n = o.mirror ? 0 : s * d.width + a * e.height,
        t.height = Math.min(this.maxHeight, t.height + n + i)) : (n = o.mirror ? 0 : a * d.width + s * e.height,
        t.width = Math.min(this.maxWidth, t.width + n + i)),
        this._calculatePadding(l, h, s, a))),
        this._handleMargins(),
        c ? (this.width = this._length = r.width - this._margins.left - this._margins.right,
        this.height = t.height) : (this.width = t.width,
        this.height = this._length = r.height - this._margins.top - this._margins.bottom)
    }
    _calculatePadding(i, a, s, n) {
        var {ticks: {align: r, padding: o}, position: l} = this.options
        ...
        if (this.isHorizontal()) {
            ...
            let t = 0
              , e = 0;
            h ? e = l ? (t = n * i.width,
            s * a.height) : (t = s * i.height,
            n * a.width) : "start" === r ? e = a.width : "end" === r ? t = i.width : "inner" !== r && (t = i.width / 2,
            e = a.width / 2),
    ...
    _convertTicksToLabels(t) {
        ...
        for (e = 0,
        i = t.length; e < i; e++)
            isNullOrUndef(t[e].label) && (t.splice(e, 1),
            i--,
            e--);
    ...
    _computeLabelSizes(t, e, i) {
        ...
        let l = 0, h = 0, d, c, u, g, p, f, m, v, x, b, _;
        for (d = 0; d < e; d += o) {
            if (g = t[d].label,
            ...
            isNullOrUndef(g) || isArray(g)) {
                if (isArray(g))
                    ...
                    u = g.length; c < u; ++c)
                        _ = g[c],
                        isNullOrUndef(_) || isArray(_) || (x = _measureText(a, m.data, m.gc, x, _),
                        b += v)
            } else
                x = _measureText(a, m.data, m.gc, x, g),
                b = v;
            n.push(x),
            r.push(b),
            l = Math.max(x, l),
    ...
    _computeGridLineItems(t) {
        ...
        "top" === n ? (v = p(this.bottom),
        k = this.bottom - d,
        D = v - u,
        P = p(t.top) + u,
        w = t.bottom) : "bottom" === n ? (v = p(this.top),
        P = t.top,
        w = p(t.bottom) - u,
        k = v + u,
        D = this.top + d) : "left" === n ? (v = p(this.right),
        y = this.right - d,
        S = v - u,
        M = p(t.left) + u,
        A = t.right) : "right" === n ? (v = p(this.left),
        M = t.left,
        A = p(t.right) - u,
        y = v + u,
        S = this.left + d) : "x" === e ? ("center" === n ? v = p((t.top + t.bottom) / 2 + .5) : isObject(n) && (m = n[f = Object.keys(n)[0]],
        v = p(this.chart.scales[f].getPixelForValue(m))),
        P = t.top,
        w = t.bottom,
        k = v + u,
        D = k + d) : "y" === e && ("center" === n ? v = p((t.left + t.right) / 2) : isObject(n) && (m = n[f = Object.keys(n)[0]],
        v = p(this.chart.scales[f].getPixelForValue(m))),
        y = v - u,
        S = y - d,
        M = t.left,
        ...
        for (x = 0; x < h; x += C) {
            ...
            void 0 !== (b = getPixelForGridLine(this, x, o)) && (_ = _alignPixel(i, b, T),
    ...
    _computeLabelItems(t) {
        ...
        var n, r = this.isHorizontal(), o = this.ticks, {align: l, crossAlign: h, padding: d, mirror: c} = s, i = getTickMarkLength(i.grid), u = i + d, d = c ? -d : u, g = -toRadians(this.labelRotation);
        const p = [];
        let f, m, v, x, b, _, y, k, S, D, M, P = "middle";
        "top" === a ? (b = this.bottom - d,
        _ = this._getXAxisLabelAlignment()) : "bottom" === a ? (b = this.top + d,
        _ = this._getXAxisLabelAlignment()) : "left" === a ? (d = this._getYAxisLabelAlignment(i),
        _ = d.textAlign,
        x = d.x) : "right" === a ? (d = this._getYAxisLabelAlignment(i),
        _ = d.textAlign,
        x = d.x) : "x" === e ? ("center" === a ? b = (t.top + t.bottom) / 2 + u : isObject(a) && (n = a[d = Object.keys(a)[0]],
        b = this.chart.scales[d].getPixelForValue(n) + u),
        _ = this._getXAxisLabelAlignment()) : "y" === e && ("center" === a ? x = (t.left + t.right) / 2 - u : isObject(a) && (n = a[d = Object.keys(a)[0]],
        ...
        m = o.length; f < m; ++f) {
            ...
            var w = s.setContext(this.getContext(f))
              , C = (y = this.getPixelForTick(f) + s.labelOffset,
            ...
            M = "top" === a ? "near" === h || 0 != g ? -D * S + S / 2 : "center" === h ? -A.highest.height / 2 - C * S + S : -A.highest.height + S / 2 : "near" === h || 0 != g ? S / 2 : "center" === h ? A.highest.height / 2 - C * S : A.highest.height - D * S,
            c && (M *= -1),
            0 == g || w.showLabelBackdrop || (x += S / 2 * Math.sin(g))) : (b = y,
            M = (1 - D) * S / 2);
            let i;
    ...
    _getYAxisLabelAlignment(t) {
        var {position: e, ticks: {crossAlign: i, mirror: a, padding: s}} = this.options
          , t = t + s
          , n = this._getLabelSizes().widest.width;
        let r, o;
        return "left" === e ? a ? (o = this.right + s,
        "near" === i ? r = "left" : "center" === i ? (r = "center",
        o += n / 2) : (r = "right",
        o += n)) : (o = this.right - t,
        "near" === i ? r = "right" : "center" === i ? (r = "center",
        o -= n / 2) : (r = "left",
        o = this.left)) : "right" === e ? a ? (o = this.left + s,
        "near" === i ? r = "right" : "center" === i ? (r = "center",
        o -= n / 2) : (r = "left",
        o -= n)) : (o = this.left + t,
        "near" === i ? r = "left" : "center" === i ? (r = "center",
        o += n / 2) : (r = "right",
        o = this.right)) : r = "right",
        {
            textAlign: r,
            x: o
        }
    ...
    drawBackground() {
        const {ctx: t, options: {backgroundColor: e}, left: i, top: a, width: s, height: n} = this;
        e && (t.save(),
        t.fillStyle = e,
        t.fillRect(i, a, s, n),
        t.restore())
    ...
    drawBorder() {
        const {chart: s, ctx: n, options: {border: t, grid: r}} = this;
        ...
        if (l) {
            var h = r.setContext(this.getContext(0)).lineWidth
              , d = this._borderValue;
            let t, e, i, a;
            this.isHorizontal() ? (t = _alignPixel(s, this.left, l) - l / 2,
            e = _alignPixel(s, this.right, h) + h / 2,
            i = a = d) : (i = _alignPixel(s, this.top, l) - l / 2,
    ...
    drawTitle() {
        var {ctx: e, options: {position: i, title: a, reverse: s}} = this;
        if (a.display) {
            var n = toFont(a.font)
              , r = toPadding(a.padding)
              , o = a.align;
            let t = n.lineHeight / 2;
            "bottom" === i || "center" === i || isObject(i) ? (t += r.bottom,
            isArray(a.text) && (t += n.lineHeight * (a.text.length - 1))) : t += r.top;
...
class TypedRegistry {
    ...
    register(t) {
        ...
        var e = t.id
          , s = this.scope + "." + e;
        if (e)
            return e in a || (registerDefaults(a[e] = t, s, i),
    ...
    unregister(t) {
        ...
        var t = t.id
          , i = this.scope;
        t in e && delete e[t],
        i && t in defaults[i] && (delete defaults[i][t],
        this.override && delete overrides[t])
    }
}
...
class Registry {
    ...
    _exec(t, e, i) {
        var a = _capitalize(t);
        callback(i["before" + a], [], i),
        e[t](i),
        callback(i["after" + a], [], i)
    }
    ...
    _notify(t, e, i, a) {
        ...
        for (const o of t) {
            var s = o.plugin
              , n = s[i]
              , r = [e, a, o.options];
            if (!1 === callback(n, r, s) && a.cancelable)
                return !1
        }
        return !0
    }
    invalidate() {
        isNullOrUndef(this._cache) || (this._oldCache = this._cache,
        this._cache = void 0)
    }
    _descriptors(t) {
        if (this._cache)
...
function retrieveAxisFromDatasets(e, t) {
    if (t.data && t.data.datasets) {
        ...
        if (t.length)
            return getAxisFromDataset(e, "x", t[0]) || getAxisFromDataset(e, "y", t[0])
    }
    return {}
}
function mergeScaleConfig(r, e) {
    const n = overrides[r.type] || {
        scales: {}
    }
      , o = e.scales || {}
    ...
    return Object.keys(o).forEach(t=>{
        ...
        var i = determineAxis(t, e, retrieveAxisFromDatasets(t, r), defaults.scales[e.type])
          ...
          , s = n.scales || {};
        h[t] = mergeIf(Object.create(null), [{
            axis: i
        }, e, s[i], s[a]])
    }
    ),
...
function initConfig(t) {
    return (t = t || {}).data = initData(t.data),
    initOptions(t),
    t
}
...
class Config {
    ...
    getOptionScopes(e, t, i) {
        ...
        Array.from(r));
        return 0 === o.length && o.push(Object.create(null)),
...
function getResolver(t, e, i) {
    ...
    t = i.join();
    let s = a.get(t);
    return s || (e = _createResolver(e, i),
    s = {
        resolver: e,
...
const hasFunction = e=>isObject(e) && Object.getOwnPropertyNames(e).some(t=>isFunction(e[t]));
...
function getCanvas(t) {
    return _isDomSupported() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
...
class Chart {
    ...
    constructor(t, e) {
        ...
        t = getChart(e);
        if (t)
            throw new Error("Canvas is already in use. Chart with ID '" + t.id + "' must be destroyed before the canvas with ID '" + t.canvas.id + "' can be reused.");
        var t = i.createResolver(i.chartOptionScopes(), this.getContext())
          , e = (this.platform = new (i.platform || _detectPlatform(e)),
        ...
        e && a ? (animator.listen(this, "complete", onAnimationsComplete),
        animator.listen(this, "progress", onAnimationProgress),
        this._initialize(),
        this.attached && this.update()) : console.error("Failed to create chart: can't acquire context from the given item")
    }
    get aspectRatio() {
        var {options: {aspectRatio: t, maintainAspectRatio: e}, width: i, height: a, _aspectRatio: s} = this;
    ...
    _initialize() {
        ...
        this.options.responsive ? this.resize() : retinaScale(this, this.options.devicePixelRatio),
        this.bindEvents(),
        this.notifyPlugins("afterInit"),
        this
    }
    clear() {
        return clearCanvas(this.canvas, this.ctx),
        this
    }
    stop() {
        return animator.stop(this),
        this
    }
    resize(t, e) {
    ...
    _resize(t, e) {
        ...
        this._aspectRatio = this.aspectRatio,
        retinaScale(this, t, !0) && (this.notifyPlugins("resize", {
            size: a
        }),
    ...
    buildOrUpdateScales() {
        const o = this.options
          , a = o.scales
          , l = this.scales
          , h = Object.keys(l).reduce((t,e)=>(t[e] = !1,
        t), {});
        let t = [];
        ...
        each(t, t=>{
            ...
            void 0 !== e.position && positionIsHorizontal(e.position, a) === positionIsHorizontal(t.dposition) || (e.position = t.dposition),
            h[i] = !0;
            let n = null;
            if (i in l && l[i].type === s)
                n = l[i];
            else {
        ...
        each(l, t=>{
            layouts.configure(this, t, t.options),
            layouts.addBox(this, t)
        }
        )
    }
    _updateMetasets() {
    ...
    buildOrUpdateControllers() {
        ...
        t = i.length; a < t; a++) {
            ...
            if (t.type && t.type !== n && (this._destroyDatasetMeta(a),
            t = this.getDatasetMeta(a)),
            t.type = n,
    ...
    update(t) {
        ...
        !1 !== this.notifyPlugins("beforeUpdate", {
            ...
            for (let t = 0, e = this.data.datasets.length; t < e; t++) {
                ...
                o.buildOrUpdateElements(n),
                i = Math.max(+o.getMaxOverflow(), i)
            }
            ...
            t ? this._eventHandler(t, !0) : a.length && this._updateHoverStyles(a, a, !0),
            this.render()
        }
    }
    _updateScales() {
    ...
    _checkEventBindings() {
        var t = this.options
          ...
          , i = new Set(t.events);
        setsEqual(e, i) && !!this._responsiveListeners === t.responsive || (this.unbindEvents(),
        this.bindEvents())
    }
    ...
    _updateDatasets(i) {
        if (!1 !== this.notifyPlugins("beforeDatasetsUpdate", {
            ...
            for (let t = 0, e = this.data.datasets.length; t < e; ++t)
                this._updateDataset(t, isFunction(i) ? i({
                    datasetIndex: t
                }) : i);
    ...
    render() {
        !1 !== this.notifyPlugins("beforeRender", {
            cancelable: !0
        }) && (animator.has(this) ? this.attached && !animator.running(this) && animator.start(this) : (this.draw(),
    ...
    draw() {
        let t;
        var e, i;
        if (this._resizeBeforeDraw && ({width: e, height: i} = this._resizeBeforeDraw,
        this._resize(e, i),
    ...
    bindResponsiveEvents() {
        ...
        const i = this._responsiveListeners
          ...
          , e = (t,e)=>{
            i[t] && (a.removeEventListener(this, t, e),
            delete i[t])
        }
          , s = (t,e)=>{
    ...
    updateHoverStyle(t, e, i) {
        var a = i ? "set" : "remove";
        let s, n, r, o;
        for ("dataset" === e && (s = this.getDatasetMeta(t[0].datasetIndex)).controller["_" + a + "DatasetHoverStyle"](),
        r = 0,
        o = t.length; r < o; ++r) {
    ...
    setActiveElements(t) {
        ...
        _elementsEqual(t, e) || (this._active = t,
    ...
    _handleEvent(t, e, i) {
        var {_active: a=[], options: s} = this
          ...
          , i = (i && (this._lastEvent = null,
        callback(s.onHover, [t, n, this], this),
        r && callback(s.onClick, [t, n, this], this)),
        !_elementsEqual(n, a));
        return (i || e) && (this._active = n,
        this._updateHoverStyles(n, a, e)),
        this._lastEvent = o,
        i
    }
...
function clipArc(t, e, i) {
    ...
    t.beginPath(),
    t.arc(s, n, r, e - l, i + l),
    a < o ? t.arc(s, n, o, i + (l = a / o), e - l, !0) : t.arc(s, n, a, i + HALF_PI, e - HALF_PI),
    t.closePath(),
    t.clip()
}
...
function pathArc(t, e, i, a, s, n) {
    ...
    let u = 0;
    var g = s - l
      , d = (a && (d = ((0 < d ? d - a : 0) + (0 < c ? c - a : 0)) / 2,
    u = (g - (0 != d ? g * d / (d + a) : g)) / 2),
    Math.max(.001, g * c - i / PI) / c)
      , a = (g - d) / 2
      , i = l + a + u
      , g = s - a - u
      ...
      , _ = g - a / x;
    t.beginPath(),
    n ? (t.arc(r, o, c, f, n = (f + m) / 2),
    t.arc(r, o, c, n, m),
    0 < l && (n = rThetaToXY(p, m, r, o),
    t.arc(n.x, n.y, l, m, g + HALF_PI)),
    p = rThetaToXY(x, g, r, o),
    t.lineTo(p.x, p.y),
    0 < a && (n = rThetaToXY(x, _, r, o),
    t.arc(n.x, n.y, a, g + HALF_PI, _ + Math.PI)),
    t.arc(r, o, h, g - a / h, l = (g - a / h + (i + s / h)) / 2, !0),
    t.arc(r, o, h, l, i + s / h, !0),
    0 < s && (p = rThetaToXY(v, b, r, o),
    t.arc(p.x, p.y, s, b + Math.PI, i - HALF_PI)),
    x = rThetaToXY(e, i, r, o),
    t.lineTo(x.x, x.y),
    0 < d && (n = rThetaToXY(e, f, r, o),
    t.arc(n.x, n.y, d, i - HALF_PI, f))) : (t.moveTo(r, o),
    _ = Math.cos(f) * c + r,
    g = Math.sin(f) * c + o,
    t.lineTo(_, g),
    a = Math.cos(m) * c + r,
...
function drawBorder(e, i, a, s, n) {
    ...
    if (d) {
        ...
        e.lineDashOffset = g,
        h ? (e.lineWidth = 2 * d,
        e.lineJoin = c || "round") : (e.lineWidth = d,
        e.lineJoin = c || "bevel");
        let t = i.endAngle;
        if (r) {
            pathArc(e, i, a, s, t, n);
...
class ArcElement extends Element {
    ...
    inRange(t, e, i) {
        var a = this.getProps(["x", "y"], i)
          , {angle: a, distance: t} = getAngleFromPoint(a, {
            x: t,
            y: e
        })
    ...
    draw(t) {
        var e, {options: i, circumference: a} = this, s = (i.offset || 0) / 4, n = (i.spacing || 0) / 2, r = i.circular;
        this.pixelMargin = "inner" === i.borderAlign ? .33 : 0,
        this.fullCircles = TAU < a ? Math.floor(a / TAU) : 0,
        0 === a || this.innerRadius < 0 || this.outerRadius < 0 || (t.save(),
...
function pathSegment(t, e, i, a) {
    ...
    let {move: d=!0, reverse: c} = a || {}, u, g, p;
    for (u = 0; u <= l; ++u)
        (g = s[(o + (c ? l - u : u)) % r]).skip || (d ? (t.moveTo(g.x, g.y),
        d = !1) : h(t, p, g, c, n.stepped),
        p = g);
    return e && (g = s[(o + (c ? l : 0)) % r],
    h(t, p, g, c, n.stepped)),
    !!e
}
function fastPathSegment(t, e, i, a) {
    ...
    let d = 0, c = 0, u, g, p, f, m, v;
    var x, b, _, y = t=>(r + (h ? o - t : t)) % n, k = ()=>{
        f !== m && (t.lineTo(d, m),
        t.lineTo(d, f),
        t.lineTo(d, v))
    }
...
class LineElement extends Element {
    ...
    updateControlPoints(t, e) {
        ...
        !a.tension && "monotone" !== a.cubicInterpolationMode || a.stepped || this._pointsUpdated || (i = a.spanGaps ? this._loop : this._fullLoop,
...
class PointElement extends Element {
    ...
    draw(t, e) {
        var i = this.options;
        this.skip || i.radius < .1 || !_isPointInArea(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor,
...
function colorizeDefaultDataset(t, e) {
    return t.borderColor = getBorderColor(e),
    t.backgroundColor = getBackgroundColor(e),
    ++e
}
function colorizeDoughnutDataset(t, e) {
    return t.backgroundColor = t.data.map(()=>getBorderColor(e++)),
    e
}
function colorizePolarAreaDataset(t, e) {
    return t.backgroundColor = t.data.map(()=>getBackgroundColor(e++)),
    e
}
...
var plugin_colors = {
    ...
    beforeLayout(t, e, i) {
        if (i.enabled) {
            ...
            var a = n["elements"];
            !i.forceOverride && (containsColorsDefinitions(s) || containsColorsDefinition(n) || a && containsColorsDefinitions(a)) || (i = getColorizer(t),
            s.forEach(i))
        }
    }
};
function lttbDecimation(a, s, n, t, e) {
    ...
    d = 0; d < i - 2; d++) {
        ...
        for (u = -1,
        i = f; i < x; i++)
            (g = .5 * Math.abs((b - t) * (a[i].y - _) - (b - a[i].x) * (e - _))) > u && (u = g,
            c = a[i],
            p = i);
        r[l++] = c,
        h = p
...
function minMaxDecimation(t, e, i, a) {
    let s = 0, n = 0, r, o, l, h, d, c, u, g, p, f;
    const m = [];
    var v = t[e].x
      , x = t[e + i - 1].x - v;
    for (r = e; r < e + i; ++r) {
        ...
        u = r),
        s = (n * s + o.x) / ++n) : (b = r - 1,
        isNullOrUndef(c) || isNullOrUndef(u) || (_ = Math.min(c, u),
        y = Math.max(c, u),
        _ !== g && _ !== b && m.push({
            ...t[_],
            x: s
...
function getStartAndCountOfVisiblePointsSimplified(t, e) {
    ...
    return o && (a = _limitValue(_lookupByKey(e, n.axis, t).lo, 0, i - 1)),
            ...
            o.data.datasets.forEach((e,t)=>{
                ...
                if ("y" !== resolve([a, o.options.indexAxis]) && t.controller.supportsDecimation) {
                    ...
                    if (("linear" === a.type || "time" === a.type) && !o.options.parsing) {
                        ...
                        if (r <= (l.threshold || 4 * h))
                            cleanDecimatedDataset(e);
                        else {
                            isNullOrUndef(i) && (e._data = s,
                            delete e.data,
            ...
            for (const u of _boundSegments(e, h)) {
                ...
                for (const g of _boundSegment(c, s, d))
                    r.push({
                        ...
                        target: u,
                        start: {
                            [i]: _getEdge(h, d, "start", Math.max)
                        },
                        end: {
                            [i]: _getEdge(h, d, "end", Math.min)
                        }
                    })
            }
        else
...
function _getBounds(i, a, s, t) {
    if (!t) {
        let t = a[i]
          , e = s[i];
        return "angle" === i && (t = _normalizeAngle(t),
        e = _normalizeAngle(e)),
        {
            property: i,
            start: t,
...
function _createBoundaryLine(t, e) {
    let i = []
      , a = !1;
    return (i = isArray(t) ? (a = !0,
    t) : _pointsFromSegments(t, e)).length ? new LineElement({
        points: i,
        options: {
            tension: 0
        },
...
function _getTargetPixel(t, e) {
    let i = null;
    return "start" === t ? i = e.bottom : "end" === t ? i = e.top : isObject(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel && (i = e.getBasePixel()),
    i
}
...
function _getTarget(t) {
    ...
    if (isNumberFinite(i))
        return getLineByIndex(e, i);
    if ("stack" === i)
        return _buildStackLine(t);
    if ("shape" === i)
        return !0;
    e = computeBoundary(t);
...
function computeCircularBoundary(t) {
    ...
    const r = [];
    if (t.grid.circular)
        return t = e.getPointPositionForValue(0, s),
        new simpleArc({
            x: t.x,
            y: t.y,
    ...
    for (let t = 0; t < a; ++t)
        r.push(e.getPointPositionForValue(t, n));
    return r
}
function _drawfill(t, e, i) {
    ...
    a && e.points.length && (clipArea(t, i),
    doFill(t, {
        line: e,
        target: a,
        above: o,
...
function doFill(t, e) {
    ...
    t.save(),
    "x" === e && n !== s && (clipVertical(t, a, r.top),
    fill(t, {
        line: i,
        target: a,
        color: s,
...
function fill(e, t) {
    ...
    for ({source: o, target: l, start: h, end: d} of _segments(i, a, s)) {
        ...
        !!i.pathSegment(e, o));
        let t;
        u && (c ? e.closePath() : interpolatedLineTo(e, a, d, s),
        u = !!a.pathSegment(e, l, {
            move: c,
            reverse: !0
        }),
...
var index = {
    ...
    afterDatasetsUpdate(t, e, i) {
        ...
        for (r = 0; r < a; ++r)
            ...
            l = null,
            o && o.options && o instanceof LineElement && (l = {
    ...
    beforeDraw(e, t, i) {
        ...
        for (let t = s.length - 1; 0 <= t; --t) {
            const r = s[t].$filler;
            r && (r.line.updateControlPoints(n, r.axis),
...
const getBoxSize = (t,e)=>{
    ...
    a = t.pointStyleWidth || Math.min(a, e)),
    {
        boxWidth: a,
        boxHeight: i,
...
class Legend extends Element {
    ...
    fit() {
        ...
        if (i.display) {
            ...
            e = this._fitRows(o, r, s, l) + 10) : (e = this.maxHeight,
            t = this._fitCols(o, n, s, l) + 10),
    ...
    _fitRows(t, i, a, s) {
        const {ctx: n, maxWidth: r, options: {labels: {padding: o}}} = this
    ...
    _fitCols(t, a, s, n) {
        const {ctx: r, maxHeight: e, options: {labels: {padding: o}}} = this
          , l = this.legendHitBoxes = []
          , h = this.columnSizes = []
          , d = e - t;
        let c = o
    ...
    adjustHitBoxes() {
        if (this.options.display) {
            var i = this._computeTitleHeight()
              , {legendHitBoxes: a, options: {align: s, labels: {padding: n}, rtl: t}} = this;
    ...
    draw() {
        var t;
        this.options.display && (t = this.ctx,
        clipArea(t, this),
        this._draw(),
        unclipArea(t))
    }
    _draw() {
        ...
        this.legendItems.forEach((t,e)=>{
            f.strokeStyle = t.fontColor,
            f.fillStyle = t.fontColor;
            ...
            w ? 0 < e && s + i + y > this.right && (n = D.y += O,
            D.line++,
            s = D.x = _alignStartEnd(m, this.left + y, this.right - p[D.line])) : 0 < e && n + O > this.bottom && (s = D.x = s + g[D.line].width + y,
            D.line++,
            n = D.y = _alignStartEnd(m, this.top + C + y, this.bottom - g[D.line].height));
            var r, o, l, h, d, c, e = b.x(s);
            e = e,
            h = n,
            d = t,
            isNaN(M) || M <= 0 || isNaN(P) || P < 0 || (f.save(),
            ...
            l = b.xPlus(e, M / 2),
            c = h + S,
            drawPointLegend(f, o, l, c, v.pointStyleWidth && M)) : (o = h + Math.max((k - P) / 2, 0),
            l = b.leftForLtr(e, M),
            c = toTRBLCorners(d.borderRadius),
            f.beginPath(),
            Object.values(c).some(t=>0 !== t) ? addRoundedRectPath(f, {
                x: l,
                y: o,
                w: M,
                h: P,
            ...
            w ? D.x += i + y : "string" != typeof t.text ? (c = _.lineHeight,
            D.y += calculateLegendItemHeight(t, c) + y) : D.y += O
        }
        ),
    ...
    drawTitle() {
        ...
        if (s.display) {
            ...
            this.isHorizontal() ? (i = Math.max(...this.lineWidths),
            t = this.top + r,
            e = _alignStartEnd(a.align, e, this.right - i)) : (l = this.columnSizes.reduce((t,e)=>Math.max(t, e.height), 0),
            t = r + _alignStartEnd(a.align, this.top, this.bottom - l - a.labels.padding - this._computeTitleHeight()));
    ...
    _getLegendItemAt(t, e) {
        ...
        if (_isBetween(t, this.left, this.right) && _isBetween(e, this.top, this.bottom))
            ...
            i = 0; i < s.length; ++i)
                if (a = s[i],
                _isBetween(t, a.left, a.left + a.width) && _isBetween(e, a.top, a.top + a.height))
                    return this.legendItems[i];
        return null
    }
    handleEvent(t) {
        var e, i, a, s = this.options;
        isListened(t.type, s) && (e = this._getLegendItemAt(t.x, t.y),
        "mousemove" === t.type || "mouseout" === t.type ? (i = this._hoveredItem,
        a = itemsEqual(i, e),
        i && !a && callback(s.onLeave, [t, i, this], this),
        (this._hoveredItem = e) && !a && callback(s.onHover, [t, e, this], this)) : e && callback(s.onClick, [t, e, this], this))
    }
}
...
var plugin_legend = {
    ...
    start(t, e, i) {
        ...
        layouts.configure(t, a, i),
        layouts.addBox(t, a)
    },
    stop(t) {
        layouts.removeBox(t, t.legend),
        delete t.legend
    },
    beforeUpdate(t, e, i) {
        const a = t.legend;
...
class Title extends Element {
    ...
    _drawArgs(t) {
        var {top: e, left: i, bottom: a, right: s, options: n} = this
          , r = n.align;
        let o = 0, l, h, d;
        return l = this.isHorizontal() ? (h = _alignStartEnd(r, i, s),
        d = e + t,
        s - i) : (o = "left" === n.position ? (h = i + t,
        d = _alignStartEnd(r, a, e),
        -.5 * PI) : (h = s - t,
        d = _alignStartEnd(r, e, a),
        .5 * PI),
        a - e),
        {
            titleX: h,
    ...
    draw() {
        var t, e, i, a, s, n = this.ctx, r = this.options;
...
const positioners = {
    average(t) {
        ...
        i = t.length; e < i; ++e) {
            const o = t[e].element;
            var r;
            o && o.hasValue() && (r = o.tooltipPosition(),
            a += r.x,
            s += r.y,
            ++n)
        }
    ...
    nearest(t, e) {
        if (!t.length)
            return !1;
        let i = e.x, a = e.y, s = Number.POSITIVE_INFINITY, n, r, o;
        for (n = 0,
        r = t.length; n < r; ++n) {
            const d = t[n].element;
            var l;
            d && d.hasValue() && (l = d.getCenterPoint(),
            (l = distanceBetweenPoints(e, l)) < s && (s = l,
            o = d))
        }
        var h;
        return o && (h = o.tooltipPosition(),
        i = h.x,
        a = h.y),
        {
            x: i,
...
function pushOrConcat(t, e) {
    return e && (isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
    t
}
...
function getTooltipSize(t, e) {
    ...
    v && (c = e.displayColors ? Math.max(o, l.lineHeight) : l.lineHeight,
...
function determineXAlign(t, e, i, a) {
    ...
    let h = "center";
    return "center" === a ? h = s <= (o + l) / 2 ? "left" : "right" : s <= n / 2 ? h = "left" : r - n / 2 <= s && (h = "right"),
...
function alignY(t, e, i) {
    let {y: a, height: s} = t;
    return "top" === e ? a += i : a -= "bottom" === e ? s + i : s / 2,
    a
}
...
class Tooltip extends Element {
    ...
    getTitle(t, e) {
        ...
        return t = pushOrConcat(t, splitNewlines(a)),
        pushOrConcat(t, splitNewlines(e))
    }
    getBeforeBody(t, e) {
    ...
    _createItems(a) {
        ...
        return a.filter && (e = e.filter((t,e,i)=>a.filter(t, e, i, s))),
    ...
    update(t, e) {
        ...
        let o, l = [];
        r.length ? (r = positioners[i.position].call(this, r, this._eventPosition),
    ...
    getCaretPosition(t, e, i) {
        ...
        p = f - i,
        f + i),
        g = c) : (u = "left" === a ? t + Math.max(n, o) + i : "right" === a ? t + e - Math.max(r, l) - i : this.caretX,
        g = "top" === s ? (p = h,
        f = p - i,
        c = u - i,
        u + i) : (p = h + d,
    ...
    drawTitle(t, e, i) {
        ...
        if (s) {
            ...
            for (t.x = getAlignedX(this, i.titleAlign, i),
    ...
    _drawColorBox(t, e, i, a, s) {
        var n, r = this.labelColors[i], o = this.labelPointStyles[i], {boxHeight: l, boxWidth: h} = s, d = toFont(s.bodyFont), c = getAlignedX(this, "left", s), c = a.x(c), d = l < d.lineHeight ? (d.lineHeight - l) / 2 : 0, e = e.y + d;
        s.usePointStyle ? (d = {
        ...
        drawPoint(t, d, o, n)) : (t.lineWidth = isObject(r.borderWidth) ? Math.max(...Object.values(r.borderWidth)) : r.borderWidth || 1,
        t.strokeStyle = r.borderColor,
        ...
        Object.values(n).some(t=>0 !== t) ? (t.beginPath(),
        t.fillStyle = s.multiKeyBackground,
    ...
    drawBody(e, i, t) {
        ...
        function p(t) {
            i.fillText(t, g.x(e.x + u), e.y + c / 2),
            e.y += c + s
        }
        var f = g.textAlign(n);
        let m, v, x, b, _, y, k;
        ...
        y = a.length; b < y; ++b) {
            ...
            each(m.before, p),
            x = m.lines,
            r && x.length && (this._drawColorBox(i, e, b, g, t),
    ...
    drawFooter(t, e, i) {
        ...
        if (s) {
            ...
            for (t.x = getAlignedX(this, i.footerAlign, i),
    ...
    _updateAnimationTarget(t) {
        var e, i, a, s = this.chart, n = this.$animations, r = n && n.x, n = n && n.y;
        (r || n) && (e = positioners[t.position].call(this, this._active, this._eventPosition)) && (i = this._size = getTooltipSize(this, t),
        a = getBackgroundPoint(t, a = Object.assign({}, e, this._size), t = determineAlignment(s, t, a), s),
        r._to === a.x && n._to === a.y || (this.xAlign = t.xAlign,
...
const addIfString = (t,e,i,a)=>("string" == typeof e ? (i = t.push(e) - 1,
a.unshift({
    index: i,
    label: e
})) : isNaN(e) && (i = null),
...
class CategoryScale extends Scale {
    ...
    parse(t, e) {
        ...
        return e = isFinite(e) && i[e] === t ? e : findOrAddLabel(i, t, valueOrDefault(e, t), this._addedLabels),
...
function generateTicks$1(t, e) {
    ...
    var {bounds: a, step: s, min: n, max: r, precision: o, count: l, maxTicks: h, maxDigits: d, includeBounds: c} = t
      ...
      , v = !isNullOrUndef(l)
      , d = (p - e) / (d + 1);
    let x = niceNum((p - e) / g / u) * u, b, _, y, k;
    if (x < 1e-14 && !f && !m)
        return [{
            value: e
        }, {
    ...
    isNullOrUndef(o) || (b = Math.pow(10, o),
    x = Math.ceil(x * b) / b),
    y = "ticks" === a ? (_ = Math.floor(e / x) * x,
    Math.ceil(p / x) * x) : (_ = e,
    p),
    f && m && s && almostWhole((r - n) / s, x / 1e3) ? (k = Math.round(Math.min((r - n) / x, h)),
    x = (r - n) / k,
    _ = n,
    y = r) : v ? (_ = f ? n : _,
    y = m ? r : y,
    k = l - 1,
    x = (y - _) / k) : (k = (y - _) / x,
    k = almostEquals(k, Math.round(k), x / 1e3) ? Math.round(k) : Math.ceil(k));
    ...
    _ < n && S++,
    almostEquals(Math.round((_ + S * x) * b) / b, n, relativeLabelSize(n, d, t)) && S++) : _ < n && S++); S < k; ++S) {
    ...
    return m && c && y !== r ? i.length && almostEquals(i[i.length - 1].value, r, relativeLabelSize(r, d, t)) ? i[i.length - 1].value = r : i.push({
        value: r
    }) : m && y !== r || i.push({
        value: y
    }),
...
class LinearScaleBase extends Scale {
    ...
    handleTickRangeOptions() {
        ...
        var n, r, o = t=>a = e ? a : t, l = t=>s = i ? s : t;
        t && (r = sign(a),
        n = sign(s),
        r < 0 && n < 0 ? l(0) : 0 < r && 0 < n && o(0)),
        a === s && (r = 0 === s ? 1 : Math.abs(.05 * s),
        l(s + r),
        t || o(a - r)),
        this.min = a,
        this.max = s
    ...
    getTickLimit() {
        let {maxTicksLimit: t, stepSize: e} = this.options.ticks, i;
        return e ? 1e3 < (i = Math.ceil(this.max / e) - Math.floor(this.min / e) + 1) && (console.warn(`scales.${this.id}.ticks.stepSize: ${e} would result generating up to ${i} ticks. Limiting to 1000.`),
    ...
    buildTicks() {
        ...
        return "ticks" === t.bounds && _setMinAndMaxByKey(a, this, "value"),
        t.reverse ? (a.reverse(),
        this.start = this.max,
...
class LogarithmicScale extends Scale {
    ...
    parse(t, e) {
        ...
        if (0 !== t)
            return isNumberFinite(t) && 0 < t ? t : null;
        this._zero = !0
    }
    determineDataLimits() {
        var {min: t, max: e} = this.getMinMax(!0);
    ...
    handleTickRangeOptions() {
        ...
        var t = t=>a = e ? a : t
          , n = t=>s = i ? s : t;
        a === s && (a <= 0 ? (t(1),
        n(10)) : (t(changeExponent(a, -1)),
        n(changeExponent(s, 1)))),
    ...
    buildTicks() {
        ...
        return "ticks" === t.bounds && _setMinAndMaxByKey(e, this, "value"),
        t.reverse ? (e.reverse(),
        this.start = this.max,
        this.end = this.min) : (this.start = this.min,
        this.end = this.max),
...
function getTickBackdropHeight(t) {
    var e = t.ticks;
    return e.display && t.display ? (t = toPadding(e.backdropPadding),
    valueOrDefault(e.font && e.font.size, defaults.font.size) + t.height) : 0
}
...
function fitWithPointLabels(e) {
    ...
    for (let t = 0; t < r; t++) {
        var h = o.setContext(e.getPointLabelContext(t))
          , d = (n[t] = h.padding,
        e.getPointPosition(t, e.drawingArea + n[t], l))
          , h = toFont(h.font)
          , h = measureLabelSize(e.ctx, h, e._pointLabels[t])
          , c = (s[t] = h,
        _normalizeAngle(e.getIndexAngle(t) + l))
...
function updateLimits(t, e, i, a, s) {
    ...
    let r = 0
      , o = 0;
    a.start < e.l ? (r = (e.l - a.start) / n,
    t.l = Math.min(t.l, e.l - r)) : a.end > e.r && (r = (a.end - e.r) / n,
    t.r = Math.max(t.r, e.r + r)),
    s.start < e.t ? (o = (e.t - s.start) / i,
    t.t = Math.min(t.t, e.t - o)) : s.end > e.b && (o = (s.end - e.b) / i,
    t.b = Math.max(t.b, e.b + o))
}
...
function buildPointLabelItems(e, i, a) {
    ...
    for (let t = 0; t < n; t++) {
        ...
        s.push(d),
        "auto" === o && (d.visible = isNotOverlapped(d, h),
        d.visible && (h = d))
    }
    return s
}
...
function yForAngle(t, e, i) {
    return 90 === i || 270 === i ? t -= e / 2 : (270 < i || i < 90) && (t -= e),
    t
}
function drawPointLabelBox(t, e, i) {
    var a, s, {left: i, top: n, right: r, bottom: o} = i, l = e["backdropColor"];
    isNullOrUndef(l) || (a = toTRBLCorners(e.borderRadius),
...
function drawPointLabels(e, i) {
    const {ctx: a, options: {pointLabels: s}} = e;
    for (let t = i - 1; 0 <= t; t--) {
        var n, r, o, l, h = e._pointLabelItems[t];
        h.visible && (drawPointLabelBox(a, n = s.setContext(e.getPointLabelContext(t)), h),
        r = toFont(n.font),
...
function pathRadiusLine(e, i, t, a) {
    const s = e["ctx"];
    if (t)
        s.arc(e.xCenter, e.yCenter, i, 0, TAU);
    else {
...
class RadialLinearScale extends LinearScaleBase {
    ...
    setCenterPoint(t, e, i, a) {
        ...
        this.drawingArea -= Math.min(this.drawingArea / 2, Math.max(t, e, i, a))
    }
    getIndexAngle(t) {
    ...
    getPointLabelContext(t) {
        ...
        if (0 <= t && t < e.length)
            return e = e[t],
            createPointLabelContext(this.getContext(), t, e)
    }
    ...
    drawBackground() {
        ...
        if (t) {
            ...
            i.save(),
            i.beginPath(),
            pathRadiusLine(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
            i.closePath(),
            i.fillStyle = t,
            i.fill(),
            i.restore()
    ...
    drawGrid() {
        ...
        let r, o, l;
        if (e.pointLabels.display && drawPointLabels(this, n),
        a.display && this.ticks.forEach((t,e)=>{
            0 !== e && (o = this.getDistanceFromCenterForValue(t.value),
            t = this.getContext(e),
            e = a.setContext(t),
            t = s.setContext(t),
    ...
    drawLabels() {
        ...
        if (l.display) {
            ...
            this.ticks.forEach((t,e)=>{
                var i, a;
                0 === e && !o.reverse || (i = l.setContext(this.getContext(e)),
                a = toFont(i.font),
                s = this.getDistanceFromCenterForValue(this.ticks[e].value),
                i.showLabelBackdrop && (r.font = a.string,
...
function determineUnitForAutoTicks(e, i, a, s) {
    ...
    for (let t = UNITS.indexOf(e); t < n - 1; ++t) {
        ...
        if (r.common && Math.ceil((a - i) / (o * r.size)) <= s)
            return UNITS[t]
    }
    return UNITS[n - 1]
}
function determineUnitForFormatting(e, i, a, s, n) {
    for (let t = UNITS.length - 1; t >= UNITS.indexOf(a); t--) {
        var r = UNITS[t];
        if (INTERVALS[r].common && e._adapter.diff(n, s, r) >= i - 1)
            return r
    }
...
function determineMajorUnit(i) {
    for (let t = UNITS.indexOf(i) + 1, e = UNITS.length; t < e; ++t)
        if (INTERVALS[UNITS[t]].common)
            return UNITS[t]
}
function addTick(t, e, i) {
    var a, s;
    i ? i.length && ({lo: a, hi: s} = _lookup(i, e),
    t[i[a] >= e ? i[a] : i[s]] = !0) : t[e] = !0
}
...
class TimeScale extends Scale {
    ...
    buildTicks() {
        var t = this.options
          ...
          , s = ("ticks" === t.bounds && a.length && (this.min = this._userMin || a[0],
        this.max = this._userMax || a[a.length - 1]),
        this.min)
          , n = this.max;
        const r = _filterBetween(a, s, n);
        return this._unit = e.unit || (i.autoSkip ? determineUnitForAutoTicks(e.minUnit, this.min, this.max, this._getLabelCapacity(s)) : determineUnitForFormatting(this, r.length, e.minUnit, this.min, this.max)),
    ...
    initOffsets(t=[]) {
        let e = 0
          , i = 0;
        this.options.offset && t.length && (a = this.getDecimalForValue(t[0]),
    ...
    _generate() {
        ...
        var e = this.min
          ...
          , l = {};
        let h = e, d, c;
        if (o && (h = +t.startOf(h, "isoWeek", s)),
        h = +t.startOf(h, o ? "day" : n),
        t.diff(i, e, n) > 1e5 * r)
            throw new Error(e + " and " + i + " are too far apart with stepSize of " + r + " " + n);
        var u = "data" === a.ticks.source && this.getDataTimestamps();
        for (d = h,
        c = 0; d < i; d = +t.add(d, r, n),
        c++)
            addTick(l, d, u);
        return d !== i && "ticks" !== a.bounds && 1 !== c || addTick(l, d, u),
        Object.keys(l).sort(sorter).map(t=>+t)
    }
    getLabelForValue(t) {
        const e = this._adapter;
...
function interpolate(t, e, i) {
    let a = 0, s = t.length - 1, n, r, o, l;
    i ? (e >= t[a].pos && e <= t[s].pos && ({lo: a, hi: s} = _lookupByKey(t, "pos", e)),
    {pos: n, time: o} = t[a],
    {pos: r, time: l} = t[s]) : (e >= t[a].time && e <= t[s].time && ({lo: a, hi: s} = _lookupByKey(t, "time", e)),
    {time: n, pos: o} = t[a],
    {time: r, pos: l} = t[s]);
    i = r - n;
